...
func (s *Store) UpsertTeam(td types.TeamDetail) error {
	...
	_, err := s.db.Exec(`
		INSERT INTO teams (id, name, slug, country, rank, logo,
		...
		td.Profile.ID, td.Profile.Name, td.Profile.Slug, td.Profile.Country, td.Ranking.WorldRank, td.Profile.Logo,
